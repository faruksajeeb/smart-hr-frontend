...
export default function UsersList() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
        ...
        meta: { ...prev.meta, total: prev.meta.total - 1, to: prev.meta.to - 1},
        }));
          ...
          <table className="min-w-full text-sm border border-gray-300 border-collapse rounded-lg overflow-hidden shadow-sm">
            <thead className="bg-gray-200 text-gray-700 font-semibold">
              <tr>
                ...
                <th className="p-3 text-left border border-gray-300">Role</th>
              ...
              {loading ? (
                ...
                usersPayload.data.map((u, index) => (
                  ...
                  >
                    ...
                    <td className="p-1 border  border-gray-300">{u.role}</td>
